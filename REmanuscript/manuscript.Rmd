...
```{r}
library(readr)
hbr_maples <- read_csv("/Users/liamwilson/Desktop/GradSchool/Semesters/FourthSemF2024/ReproducibilityR/ReproducibilityProjectF2024/ReproducibilityGitProject/RErawdata/hbr_maples.csv")
View(hbr_maples)
```
